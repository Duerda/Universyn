...
function bindResize(windowElement) {
  ...
  const move = (event) => {
    ...
    const verticalDelta = event.clientY - resize.startY;
    const height = Math.max(minHeight, resize.height - verticalDelta);
